...
const naverSens = require('./utils/naver-sens');
...
cron.schedule('0 21 * * *', () => {
    console.log('[Cron] Running daily full code backup...');
...
const {
    ...
    HERB_INBOUND_LOG_FILE, PURCHASES_FILE, PRESET_PRESCRIPTIONS_FILE,
...
app.use('/api', require('./routes/bookingCalendar'));
app.use('/api', require('./routes/jabo'));
...
app.use('/api/receipt-book', require('./routes/dailyReceiptBook'));
