...
// app.use('/api', require('./routes/naverReviews'));


// ===========================================
// 환자 이미지 관리 API
// ===========================================
// app.use('/api', require('./routes/patientImages'));
...
app.use('/api/alltalk', require('./routes/alimtalk')); // [New] AlimTalk Management
app.use('/api/agent/alimtalk', require('./routes/agentAlimtalk')); // [New] Template Sync & Post-Treatment Agent
// app.use('/api/send-alimtalk', require('./routes/alimtalk')); // Alias removed to avoid conflict with /api/send-alimtalk in routes/messages.js


// ===========================================
// 주소 검색 API (카카오/vWorld)
// ===========================================
